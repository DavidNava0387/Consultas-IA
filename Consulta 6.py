...
class consulta6:
    def __init__(self, root):
        self.root=root
        self.root.title("Consulta 6")
        
        #Consulta 6 (variables)
        self.normal=50
        self.macro=20
        self.price=300
        self.texto1=tk.Label(self.root, text="Cámaras con rango de enfoque normal mayor a 50, rango de enfoque macro mayor a 20 que tengan un valor igual o mayor a $300")
        self.texto1.pack()
    ...
    #Consulta 6 (funcion)    
    def consulta6(self):
        c1=df_archivo_3.query("`Normal focus range`>@self.normal and `Macro focus range`>@self.macro and `Price`>=@self.price")
